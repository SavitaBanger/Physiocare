          ...
          <div class="container">
            <div class="banner-container row align-items-center">
              ...
              <div class="banner-info col-12 col-md-6 text-center mb-4 mb-md-0">
                <img src="src/img/home/banner-info.jpg" alt="banner-info" class="img-fluid shadow" style="max-height: 400px;">
              </div>

              <!-- Right Content -->
              <div class="banner-content col-12 col-md-6 text-center text-md-start align-items-center d-flex flex-column align-items-md-start">
                <h1 class="fw-bold text-white">Recover, Strengthen, and Thrive with Expert Physiotherapy Care</h1>
                <p class="text-light mt-3">
                Personalized treatment plans to help you move better and live pain-free.
                </p>
                <!-- Button to Open the Modal -->
                <div class="buttons">
                    <a href="javascriptvoid:(0);" class="btn-blue"  data-bs-toggle="modal" data-bs-target="#preAssessmentModal" >Pre-Assessment</a>
                  </div>
              </div>
  ...
  <section class="overview">
    <div class="container">
      ...
      <div class="content col-md-7" data-aos="fade-up" data-aos-delay="100">
            ...
            We specialize in personalized video-based treatment plans to help you recover from the comfort of your home.
            </p>
            <ul>
  ...
  <div class="container">
    <div class="about-container row">
      <div class="heading center-heading mb-5">
        <h2>What We Treat</h2>
        <p class="text-center">At Physiocare, we specialize in evidence-based treatments to relieve pain and restore mobility.</p>
      </div>
      ...
      <div class="about-item col-lg-4 d-flex flex-column align-items-center">
        ...
        <h3>Knee Pain</h3>
        <p class="text-center">Our personalized physiotherapy programs help reduce knee pain caused by arthritis, injuries, or post-surgical recovery. Strength training, manual therapy, and guided exercises support long-term relief.</p>
      </div>
      ...
      <div class="about-item col-lg-4 d-flex flex-column align-items-center">
        ...
        <h3>Back Pain</h3>
        <p class="text-center">We treat chronic and acute back pain with a combination of spinal mobilization, posture correction, and core strengthening techniques to improve spinal health and flexibility.</p>
      </div>

      <div class="about-item col-lg-4 d-flex flex-column align-items-center">
        <span class="d-flex mb-3">
          <img src="src/img/home/sholder-pain.jpg" alt="Neck Pain" class="img-fluid shadow rounded-circle">
        </span>
        <h3>Neck Pain</h3>
        <p class="text-center">Neck stiffness, tension, or postural pain is treated through manual therapy, soft tissue mobilization, and customized exercises to improve neck movement and reduce discomfort.</p>
      </div>
            ...
            <div class="heading center-heading white-heading">
              ...
              <div class="row justify-content-md-around">
                ...
                <div class="work-item mb-5 text-center  align-items-center d-flex flex-column col-md-5 col-lg-4">
                    ...
                    <p class="text-white">Patients fill out a form providing information about their condition before any treatment.</p>
                  </div>
                  ...
                  <div class="work-item mb-5 text-center  align-items-center d-flex flex-column col-md-5 col-lg-4">
                    ...
                    <p class="text-white">We collect recovery feedback from the patient to evaluate progress after exercises.</p>
                  </div>
